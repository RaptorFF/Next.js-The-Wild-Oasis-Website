...
export const revalidate = 86400; // Cache the page for 24 hours (86400 seconds). After that, the next request will trigger a revalidation and fetch fresh data.
...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* relative is needed for the image to fill the div and aspect-square makes sure the div is always a square */}
      <div className="col-span-2 relative aspect-square">
        {" "}
        {/* example of using next/image but with src as a string instead of an import, when we want to use the image in a more dynamic way, for example if we get the image url from an api */}
        <Image
          src="/about-2.jpg"
          fill
          className="object-cover" // make sure the image covers the whole div without distortion
